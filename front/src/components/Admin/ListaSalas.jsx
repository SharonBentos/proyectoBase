...
import { obtenerSalas, eliminarSala, crearSala, actualizarSala } from "../../services/api";
    ...
    <Layout>
      <div className="lista-participantes">
        <div className="page-header">
          ...
          <button className="btn-primary" onClick={abrirModalNuevo}>+ Nueva Sala</button>
        </div>
            ...
            <tbody>
              {salas.map(s => (
                <tr key={`${s.nombre_sala}-${s.edificio}`}>
                  ...
                  <td>{s.tipo_sala}</td>
                  <td>
                    <button className="btn-edit" onClick={() => abrirModalEditar(s)}>Editar</button>
                    <button 
