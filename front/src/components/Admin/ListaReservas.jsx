...
import { obtenerReservas, cancelarReserva, crearReserva, obtenerSalas, obtenerTurnos, obtenerParticipantes } from "../../services/api";
import { formatDate, formatTime, getEstadoColor, getTodayString } from "../../utils/helpers";
...
const ListaReservas = () => {
  ...
  const agregarParticipante = () => {
    ...
    setFormData({
      ...formData,
      participantes_ci: [...formData.participantes_ci, participanteSeleccionado]
    });
    setParticipanteSeleccionado('');
  };
    ...
    <Layout>
      <div className="lista-participantes">
        <div className="page-header">
          ...
          <button className="btn-primary" onClick={abrirModalNuevo}>+ Nueva Reserva</button>
        </div>
            ...
            <tbody>
              {reservas.map(r => (
                <tr key={r.id_reserva}>
                  ...
                  <td>
                    <button className="btn-edit" onClick={() => verDetalles(r)}>Ver</button>
                    {r.estado === 'activa' && (
                      <button 
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="form-group">
                  ...
                  <div style={{display: 'flex', gap: '8px', marginBottom: '12px'}}>
                    ...
                    <button type="button" className="btn-primary" onClick={agregarParticipante}>
                      Agregar
                    </button>
                  </div>
            ...
            <div className="modal-content" onClick={(e) => e.stopPropagation()}>
              ...
              <div style={{padding: '24px'}}>
                <div className="detalle-item">
                  <strong>Sala:</strong> {mostrarDetalles.nombre_sala} - {mostrarDetalles.edificio}
                </div>
                <div className="detalle-item">
                  <strong>Fecha:</strong> {formatDate(mostrarDetalles.fecha)}
                </div>
                <div className="detalle-item">
                  <strong>Horario:</strong> {formatTime(mostrarDetalles.hora_inicio)} - {formatTime(mostrarDetalles.hora_fin)}
                </div>
                <div className="detalle-item">
                  ...
                  }}>{mostrarDetalles.estado}</span>
                </div>
                
                {mostrarDetalles.participantes && mostrarDetalles.participantes.length > 0 && (
                  <div className="detalle-item">
